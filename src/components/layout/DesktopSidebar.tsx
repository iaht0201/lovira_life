        ...
        {isCollapsed ? (
          <div className="flex flex-col items-center gap-2">
            <button
              ...
              className="w-[42px] h-[42px] rounded-2xl bg-lovira-badge-purple hover:ring-2 hover:ring-[#287C78]/40 flex items-center justify-center overflow-hidden transition-all cursor-pointer shadow-2xs"
              title={`Hồ sơ: ${userName} (${planName})`}
            >
